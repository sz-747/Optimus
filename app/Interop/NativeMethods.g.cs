...
namespace Optimus.Interop
{
    internal static unsafe partial class NativeMethods
    {
        ...
        ///  `engine` must be a live handle from [`optimus_engine_create`] (or null → returns 0).
        /// </summary>
        [DllImport(__DllName, EntryPoint = "optimus_engine_child_process_handle", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern nuint optimus_engine_child_process_handle(Engine* engine);
